...
<div class="field field-type-filefield field-field-imagem">
  ...
  <ul>
    <?php
		foreach ((array)$node->field_page_imagem as $item) print '<li><a rel="lightbox" href="/' . $item['filepath'] . '" >' . theme('imagecache', '114x76', $item['filepath'], '', '',  array('id'=>'small_image_id','class'=>'image')) . '</a></li>';
	?>
	</ul>
  </div>
</div>
