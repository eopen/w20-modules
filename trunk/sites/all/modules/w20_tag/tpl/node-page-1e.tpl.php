  ...
  <div class="field-items">
	...
	<?php
		foreach ((array)$node->field_page_imagem as $item) {
			print '<a rel="lightbox" href="/' . $item['filepath'] . '" >' . theme('imagecache', '240x160', $item['filepath'], '', '',  array('id'=>'small_image_id','class'=>'image')) . '</a>';
		}
	?>
